			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.xieyusheng.model.Order o=(com.xieyusheng.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.xieyusheng.dao.UserDao userDao=new com.xieyusheng.dao.UserDao();
						...
						<%
							...
							String paymentType=com.xieyusheng.model.Payment.findByPaymentId(con,n);
							 %>
